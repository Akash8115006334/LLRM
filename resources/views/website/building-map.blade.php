<!DOCTYPE html>
<html lang="zxx">
  <!-- Mirrored from templates.envytheme.com/unco/default/{{route('infrastructure-details')}} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2022 04:42:02 GMT -->
    ...
    <section class="campus-information-area ptb-100">
      <div class="container">
        <div class="main-default-content">
          <h3>Building Map</h3>
          <p>
            College campus provides good academic environment to its students.
            The classrooms are spacious, well illuminated and ventilated with
            comfortable furniture. College has five lawns and tree chains along
            the wall that balances the ratio of concrete and nature.
          </p>
          <div class="gap-20"></div>
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
              <div class="single-gallery img-gallery-style">
                <img src="assets/images/building-map/1.jpg" alt="Image" style="height: 549px" />
              </div>
              <div class="gap-20"></div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="single-gallery img-gallery-style">
                <img src="assets/images/building-map/2.jpg" alt="Image" style="height: 549px" />
              </div>
              <div class="gap-20"></div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="single-gallery img-gallery-style">
                <img src="assets/images/building-map/3.jpg" alt="Image" style="height: 549px" />
              </div>
              <div class="gap-20"></div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="single-gallery img-gallery-style">
                <img src="assets/images/building-map/4.jpg" alt="Image" style="height: 549px" />
              </div>
              <div class="gap-20"></div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="single-footer-widget bg-f9f5f1">
              <a href="{{route('home')}}" class="logo">
                <img src="assets/images/white-logo.png" alt="Image" class="image-bg-color" />
              </a>

              <p>
                Lala Lajpat Rai Memorial College Of Education. Year Of
                Affiliation :-2003, Permanently affiliated to Punjab University,
                Chandigarh, Recognized by UGC Under Section 2(f) and 12 (B) of
                the UGC Act 1956 MOU (Memorandum of Understanding) with New
                Zealand.
              </p>
  ...
  <!-- Mirrored from templates.envytheme.com/unco/default/{{route('infrastructure-details')}} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2022 04:42:03 GMT -->
