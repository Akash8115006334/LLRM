<!DOCTYPE html>
<html lang="zxx">
  <!-- Mirrored from templates.envytheme.com/unco/default/tuition-fees.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2022 04:42:00 GMT -->
  ...
  <body>
    ...
    <!-- End Tuition Fees Area -->
    <section class="tuition-fees-area ptb-100">
      <div class="container">
        <div class="main-default-content">
          <h2>What our tuition fees</h2>
          <p>
            ...
            id enim. Praesent sapien massa, convallis a pellentesque nec,
            egestas non nisi. Cras ultricies ligula sed magna dictum porta.
            Curabitur non nulla sit amet nisl tempus convallis quis ac lectus.
            Vestibulum ac diam sit amet quam vehicula elementum sed sit amet
            dui. Donec rutrum congue leo eget malesuada. Donec rutrum congue leo
            eget malesuada. Pellentesque in ipsum id orci porta dapibus.
            Curabitur aliquet quam id ut lacinia in elementum id enim. Praesent
            sapien massa, convallis a pellentesque nec, egestas non nisi leo
            eget malesuada.
          </p>
          ...
          <h3>Tuition fees normally cover</h3>
          ...
          <ul>
            ...
            <li>Lacinia eget consectetur sed convallis at tellus.</li>
            <li>
          ...
          <h3>How much are tuition fees?</h3>
          <p>
            ...
            tincidunt. Sed porttitor lectus nibh. Pellentesque in ipsum id orci
            porta dapibus.Nulla quis lorem ut libero malesuada feugiat. Proin
            eget tortor risus. Nulla porttitor accumsan tinci dunt. Donec rutrum
            congue leo eget malesuada. Vestibulum ac diam sit amet quam vehicula
            elementum sed sit amet dui. Vivamus magna justo.
          </p>
          <p>
            Quisque velit nisi, pretium ut lacinia in, elementum id enim. Proin
            eget tortor risus. Lorem ipsum dolor sit amet, consectetur
          ...
          <h3 class="mb-20">Courses Fee Structure</h3>

          <div class="row justify-content-center align-items-center">
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3><a href="courses-details.html">B.Ed.-I</a></h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
                    <br />
                ...
                <p>
                  ...
                  <span class="price"> <br />(July - December)</span>
                  <span></span>
                </p>

                <ul>
                  <li>Grand Total</li>
                  <li class="price">72000/-</li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3><a href="courses-details.html">B.Ed.-II</a></h3>
                <p>
                  <span>Fee</span> <span class="price"> <br />60000/-</span>
                  <span></span>
                </p>
                ...
                <p>
                  <span>Course Durations</span>
                  <span class="price"> <br />(January - June)</span>
                  <span></span>
                </p>

                <ul>
                  <li>Grand Total</li>
                  <li class="price">65000/-</li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3><a href="courses-details.html">M.Ed.-I</a></h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
                    <br />
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3><a href="courses-details.html">M.Ed.-II</a></h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
                    <br />
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3>
                  <a href="courses-details.html">D.El.Ed.-I(Through Counseling)</a>
                </h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3>
                  <a href="courses-details.html">D.El.Ed.-I (Through Management Quota)</a>
                </h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3>
                  <a href="courses-details.html">D.El.Ed.-II(Through Counseling)</a>
                </h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="single-costing-card">
                <span class="subtitle">Course</span>
                <h3>
                  <a href="courses-details.html">D.El.Ed.-II (Through Management Quota)</a>
                </h3>
                <p>
                  <span>Fee</span>
                  <span class="price">
          ...
          <!-- <h3>What financial help can you get?</h3>
					...
					<div class="course-odf-bg">
						<div class="single-costing-card">
							<span class="subtitle">Course</span>
							<h3>B.Ed.-I</h3>
							<p><span>Fee</span> <span class="price"> <br> 67000/-</span> <span></span></p>

							<p><span>Examination Fee</span> <span class="price"> <br> 5000/-</span> <span></span></p>
								
							<p><span>Course Durations</span> <span class="price"> <br>(July - December)</span> <span></span></p>
            ...
            <div class="single-footer-widget">
              ...
              <ul class="address">
                ...
                <li>
                  ...
                  <span>Email</span>
                  <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#ff96919990bf8a919c90d19c9092"><span
                      class="__cf_email__" data-cfemail="6801060e07281d060b07460b0705">[email&#160;protected]</span></a>
                </li>
                <li>
                  <a href="tel:+1-(981)-436-0329">
                    <i class="ri-phone-fill"></i>
