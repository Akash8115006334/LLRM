      ...
      <div class="container">
        <div class="page-title-content">
          ...
          <ul>
            ...
            <li class="active">NCTE Orders</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <section class="campus-experiences-area ptb-100">
      <div class="container">
        <div class="main-default-content">
          ...
          <ul>
            <li>
              <a href="ncte-revised/b-ed.pdf" target="_blank">Building Map</a>
            </li>
            <li>
              <a href="ncte-revised/m-ed.pdf" target="_blank">Details of Library</a>
            </li>
            <li>
              <a href="ncte-revised/d-el-ed.pdf" target="_blank">Faculty List</a>
            </li>
            <li>
              <a href="ncte-revised/d-el-ed.pdf" target="_blank">NCTE Orders</a>
            </li>
          </ul>
