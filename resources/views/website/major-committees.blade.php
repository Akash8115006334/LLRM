      ...
      <div class="container">
        <div class="page-title-content">
          ...
          <ul>
            ...
            <li class="active">Major Committees</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="main-default-content">
          ...
          <ul>
            ...
            <li>Academic Activities Committee</li>
            <li>Admission Committee</li>
            <li>Extension Activities Committee</li>
            <li>Extra Curricular Committee</li>
            <li>Infrastructure Development and Maintenance Committee</li>
            <li>Library Advisory Committee</li>
            <li>Equal Opportunity Committee</li>
            <li>Media Communication Committee</li>

            <li>Web-site and e-resources Development Committee</li>
          </ul>

          <ul class="gap-ml-50">
            <li>Hostel Committee</li>
            <li>Magazine Committee</li>
            <li>Cleanliness Committee</li>
            <li>Refresh Committee</li>
            <li>Decoration Committee</li>
            <li>Purchase Committee</li>
            <li>Sports Committee</li>
            <li>Feedback Analysis Committee</li>
            <li>Tour Committee</li>
