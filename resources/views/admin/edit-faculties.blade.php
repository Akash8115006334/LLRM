                                                        ...
                                                        <div class="tab-pane active" id="home7" role="tabpanel">
                                                            ...
                                                            <div class="row mb-3 ">
                                                                <div class="col-md-9">
                                                                    ...
                                                                    @endif
                                                                    <form
                                                                        action="{{route('editFaculties',['id' => $OurFacultie->id])}}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="text" name="name"
                                                                                    class="form-control"
                                                                                    value="{{ old('name', $OurFacultie->name ?? '')}}"
                                                                                    required>
                                                                                @error('name')
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="text" name="designation"
                                                                                    class="form-control"
                                                                                    value="{{ old('designation',$OurFacultie->designation ?? '')}}"
                                                                                    required>
                                                                                @error('designation')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="text" name="phone"
                                                                                    class="form-control"
                                                                                    value="{{ old('phone',$OurFacultie->phone ?? '')}}"
                                                                                    required>
                                                                                @error('phone')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="address"
                                                                                    ...
                                                                                    required>{{ old('address',$OurFacultie->address ?? '')}}</textarea>
                                                                                @error('address')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-block text-center">
                                                                            ...
                                                                            <img src="{{ Storage::url($OurFacultie->image) }}"
                                                                                alt="profile image"
                                                                                style="width: 225px;">
