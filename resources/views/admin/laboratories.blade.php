        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Laboratories Details Page</h5>
                        <span>Here you can add,update and delete Laboratories Details page slider image and Laboratories
                            Details
                            card image and
                            text
                            etc.</span>
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active " data-bs-toggle="tab"
                                                                href="#home7" role="tab"><i
                                                                    class="feather icon-power"></i>Laboratories
                                                                Details
                                                                Card</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="home7" role="tabpanel">
                                                            <form action="{{route('addLaboratories')}}" method="post"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <label
                                                                                    ...
                                                                                    Image <span class="text-danger"> (In jpg,jpeg,png & width:460px, height:310px & size < 2mb)</span></label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card">
                                                                    <div class="card-header">
                                                                        <h5>All Laboratories Card List</h5>
                                                                    </div>
                                                                        ...
                                                                        <div class=" ">
                                                                            <table
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    $sno = 0;
                                                                                    @endphp
                                                                                    @foreach ($LaboratoriesCard as $card)
                                                                                    @php
                                                                                    $sno++;
                                                                                    @endphp
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="d-inline-flex">
                                                                                            <div>
                                                                                                <a href="{{route('editLaboratories', ['id' => $card->id])}}"
                                                                                                    class="btn btn-primary btn-sm p-2"><i
                                                                                                        class="feather icon-eye m-0 p-0"></i></a>
                                                                                            </div>
                                                                                            <div>
                                                                                                <form
                                                                                                    action="{{ route('deleteLaboratories', ['id' => $card->id]) }}"
                                                                                                    method="post">
                                                                                                    @csrf
                                                                                                    @method('DELETE')
                                                                                                    <button
