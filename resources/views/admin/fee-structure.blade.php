                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    ...
                                                    <ul class="nav nav-tabs md-tabs " role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>Fee Structure
                                                                Section</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link " data-bs-toggle="tab" href="#home7"
                                                                role="tab"><i class="feather icon-power"></i>Fee
                                                                Structure
                                                                Pdf</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('updatefeeStructureSection')}}"
                                                                method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                <input type="hidden" name="Id"
                                                                    value="{{ $FeeStructureSection->id ??'' }}">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    class="form-control"
                                                                                    value="{{ old('title',$FeeStructureSection->title ?? '')}}">
                                                                                @error('title')
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="subtitle"
                                                                                    ...
                                                                                    required>{{ old('subtitle', $FeeStructureSection->subtitle ?? '' )}}</textarea>
                                                                                @error('subtitle')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                        ...
                                                        <div class="tab-pane" id="home7" role="tabpanel">
                                                            <form action="{{route('addfeeStructure')}}" method="post"
                                                                ...
                                                                <div class="row mb-3 ">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <label
                                                                                    class="form-label col-form-label">Fee
                                                                                    Structure
                                                                                    Pdf <span class="text-danger"> (In
                                                                                        pdf size < 2mb)</span></label>
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th >{{$FeeStructure->title}}
                                                                                        </th>

                                                                                        <td>
                                                                                            <a href="{{ Storage::url($FeeStructure->image) }}"
                                                                                                target="_blank">
                                                                                                <embed
                                                                                                    src="{{ Storage::url($FeeStructure->image) }}"
                                                                                                    width="140"
                                                                                                    height="80"
                                                                                        ...
                                                                                        <td class="d-inline-flex">
                                                                                            <div>
                                                                                                <a href="{{route('editfeeStructure', ['id' => $FeeStructure->id])}}"
                                                                                                    class="btn btn-primary btn-sm p-2"><i
                                                                                                        class="feather icon-eye m-0 p-0"></i></a>
                                                                                            </div>
                                                                                            <div>
                                                                                                <form
                                                                                                    action="{{ route('deletefeeStructure', ['id' => $FeeStructure->id]) }}"
                                                                                                    method="post">
                                                                                                    @csrf
                                                                                                    @method('DELETE')
                                                                                                    <button
