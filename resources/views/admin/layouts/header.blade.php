				...
				<div class="navbar-logo d-flex justify-content-center">
					...
					<a href="index.html">
						<img class="img-fluid rounded mx-auto d-block"
							src="{{ Storage::url($websiteSetting->websiteLogo) }}" alt="Theme-Logo"
							style="width:78px; height:78px;" />
					</a>
					@else
					<img src="{{ url('admin-assets/assets/images/user.png') }}" alt="profile image" width="100">
					@endif
								...
								<ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn"
										...
										<div class="d-flex">
											<div class="flex-shrink-0">
												<img class="img-radius"
													src="{{url('admin-assets/assets/images/avatar-4.jpg')}}"
									...
									<li>
										<div class="d-flex">
											<div class="flex-shrink-0">
												<img class="img-radius"
													src="{{url('admin-assets/assets/images/avatar-3.jpg')}}"
													alt="Generic placeholder image">
											</div>
											<div class="flex-grow-1">
						...
						<li class="user-profile header-notification">
							<div class="dropdown-primary dropdown">
								<div class="dropdown-toggle" data-bs-toggle="dropdown">
									...
									<img src="{{ Storage::url(auth()->user()->image)}}" class="img-radius"
										alt="User-Profile-Image">
									@else
									<img src="{{url('admin-assets/assets/images/avatar-4.jpg')}}" class="img-radius"
										alt="User-Profile-Image">
									<span>John Doe</span>
									@endif
							...
							<div class="media userlist-box waves-effect waves-light" data-id="2" data-status="online"
								...
								<a class="media-left" href="#!">
									<img class="media-object img-radius"
										src="{{url('admin-assets/assets/images/avatar-2.jpg')}}"
										alt="Generic placeholder image">
									<div class="live-status bg-success"></div>
								</a>
								<div class="media-body">
