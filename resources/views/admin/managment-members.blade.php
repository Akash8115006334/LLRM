                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>Managment
                                                                Member Section</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link " data-bs-toggle="tab" href="#home7"
                                                                role="tab"><i class="feather icon-power"></i>Managment
                                                                Member</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('addManagementSection')}}"
                                                                method="post">
                                                                @csrf
                                                                <input type="hidden" name="Id"
                                                                    value="{{ $ManagmentSection->id ??'' }}">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    class="form-control"
                                                                                    value="{{ old('title', $ManagmentSection->title ?? '' )}}"
                                                                                    required>
                                                                                @error('title')
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="subtitle"
                                                                                    ...
                                                                                    required>{{ old('subtitle', $ManagmentSection->subtitle ?? '' )}}</textarea>
                                                                                @error('subtitle')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                        ...
                                                        <div class="tab-pane" id="home7" role="tabpanel">
                                                            ...
                                                            <div class="row mb-3 ">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @endif
                                                                    <form action="{{route('addManagementMember')}}"
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="d-inline-flex">
                                                                                                <div>
                                                                                                    <a href="{{route('editManagmentMember', ['id' => $card->id])}}"
                                                                                                        class="btn btn-primary btn-sm p-2"><i
                                                                                                            class="feather icon-eye m-0 p-0"></i></a>
                                                                                                </div>
                                                                                                <div>
                                                                                                    <form
                                                                                                        action="{{ route('deleteManagmentMember', ['id' => $card->id]) }}"
                                                                                                        method="post">
                                                                                                        @csrf
                                                                                                        @method('DELETE')
                                                                                                        <button
