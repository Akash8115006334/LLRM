                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    ...
                                                    <div class="tab-content card-block">
                                                        ...
                                                        <div class="tab-pane active " id="profile7" role="tabpanel">
                                                            <form action="{{route('addBlogDetails')}}" method="post"
                                                                            ...
                                                                            <table class="table table-xs">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>{{ \Carbon\Carbon::parse($slider->date)->format('d M Y') }}

                                                                                        </td>
                                                                                        <td>
                                                                                            {{ \Carbon\Carbon::parse($slider->time)->format('h:i A') }}
                                                                                        </td>
                                                                                        <td>{{$slider->authorName}}
                                                                                        </td>

                                                                                        <td class="d-inline-flex">
                                                                                            <div>
                                                                                                <a href="{{route('editBlogDetails', ['id' => $slider->id])}}"
                                                                                                    class="btn btn-primary btn-sm p-2"><i
                                                                                                        class="feather icon-eye m-0 p-0"></i></a>
                                                                                            </div>
                                                                                            <div>
                                                                                                <form
                                                                                                    action="{{ route('deleteBlogDetails', ['id' => $slider->id]) }}"
                                                                                                    method="post">
                                                                                                    @csrf
                                                                                                    @method('DELETE')
                                                                                                    <button
