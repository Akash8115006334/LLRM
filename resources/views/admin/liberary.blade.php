                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>Liberary
                                                                Section Details</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link " data-bs-toggle="tab" href="#home7"
                                                                role="tab"><i class="feather icon-power"></i>Liberary
                                                                Details
                                                                Card</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('updateLiberaryDetials')}}"
                                                                method="post">
                                                                @csrf
                                                                <input type="hidden" name="Id"
                                                                    value="{{ $LiberarySectionDetail->id ??'' }}">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    class="form-control"
                                                                                    value="{{ old('title', $LiberarySectionDetail->title ?? '' )}}"
                                                                                    required>
                                                                                @error('title')
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="subtitle"
                                                                                    ...
                                                                                    required>{{ old('subtitle', $LiberarySectionDetail->subtitle ?? '' )}}</textarea>
                                                                                @error('subtitle')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="additionalContent"
                                                                                    class="form-control" rows="2"
                                                                                    id="ckeditor"
                                                                                    required>{{ old('additionalContent', $LiberarySectionDetail->additionalContent ?? '' )}}</textarea>
                                                ...
                                                <div class="tab-pane" id="home7" role="tabpanel">
                                                    <form action="{{route('addLiberaryDetials')}}" method="post"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <label class="form-label col-form-label">Upload
                                                                             Icon Image  <span class="text-danger"> (In jpg,jpeg,png & width:60px, height:60px & size < 2mb)</span></label>
                                                                ...
                                                                <div class=" ">
                                                                    <table
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            $sno = 0;
                                                                            @endphp
                                                                            @foreach ($LiberaryCardsDetail as $card)
                                                                            @php
                                                                            $sno++;
                                                                            @endphp
                                                                            <tr>
                                                                                ...
                                                                                <td class="d-inline-flex">
                                                                                    <div>
                                                                                        <a href="{{route('editLiberaryDetials', ['id' => $card->id])}}"
                                                                                            class="btn btn-primary btn-sm p-2"><i
                                                                                                class="feather icon-eye m-0 p-0"></i></a>
                                                                                    </div>
                                                                                    <div>
                                                                                        <form
                                                                                            action="{{ route('deleteLiberaryDetials', ['id' => $card->id]) }}"
                                                                                            method="post">
                                                                                            @csrf
                                                                                            @method('DELETE')
                                                                                            <button type="submit"
