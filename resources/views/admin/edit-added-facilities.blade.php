                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#home7" role="tab"><i
                                                                    class="feather icon-power"></i>Added Facilities
                                                                Card</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        ...
                                                        <div class="tab-pane active" id="home7" role="tabpanel">
                                                            <form
                                                                action="{{route('editOtherFacilities',['id' => $AddedFacilitiesCard->id])}}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    value="{{$AddedFacilitiesCard->title}}"
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="description"
                                                                                    ...
                                                                                    id="ckeditor"
                                                                                    required>{{$AddedFacilitiesCard->description}}</textarea>
                                                                                @error('description')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-block text-center">
                                                                                ...
                                                                                <img src="{{ Storage::url($AddedFacilitiesCard->image) }}"
                                                                                    alt="profile image"
                                                                                    style="width: 225px;">
