...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/tooltip.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:49 GMT -->
<head>
...
<ul>
<li>
<button type="button" class="btn btn-default waves-effect" data-bs-toggle="tooltip" data-placement="top" title="tooltip on top">Top
</button>
</li>
<li>
<button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="tooltip" data-placement="left" title="tooltip on left">Left
</button>
</li>
<li>
<button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="tooltip" data-placement="right" title="tooltip on right">right
</button>
</li>
<li>
<button type="button" class="btn btn-warning waves-effect waves-light" data-bs-toggle="tooltip" data-placement="bottom" title="tooltip on bottom">bottom
</button>
</li>
<li>
<button type="button" class="btn btn-info waves-effect waves-light" data-bs-toggle="tooltip" data-html="true" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">Html Tooltip
</button>
</li>
</ul>
</div>
...
<a href="#!" data-bs-toggle="tooltip" data-placement="top" data-trigger="hover" title="top!">Top</a>
<a href="#!" data-bs-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="bottom!">Bottom</a>
<a href="#!" data-placement="left" data-trigger="hover" data-bs-toggle="tooltip" title="left!">Left</a>
<a href="#!" data-placement="right" data-trigger="hover" data-bs-toggle="tooltip" title="right!">Right</a>
</div>
</div>
...
<p>use code in button for tooltip <code>data-bs-toggle="tooltip" data-placement="left" data-original-title=".icofont-home"</code></p>
<button type="button" class="btn btn-primary btn-icon waves-effect waves-light" data-bs-toggle="tooltip" data-placement="left" title=".icofont-home">
<i class="icofont icofont-home"></i>
</button>
<button type="button" class="btn btn-danger btn-icon waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".icofont icofont-search-alt-2">
<i class="icofont icofont-search-alt-2"></i>
</button>
<button type="button" class="btn btn-warning btn-icon waves-effect waves-light" data-bs-toggle="tooltip" data-placement="right" title=".icofont-refresh">
<i class="icofont icofont-refresh"></i>
</button>
<button type="button" class="btn btn-info btn-icon waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".icofont-print">
<i class="icofont icofont-print"></i>
</button>
<button type="button" class="btn btn-success btn-icon waves-effect waves-light" data-bs-toggle="tooltip" data-placement="bottom" title=".icofont-paper-plane">
...
<p>use code in button for tooltip <code>data-bs-toggle="popover" data-placement="left" data-original-title=".icofont-home"</code></p>
<button type="button" class="btn btn-default waves-effect" data-bs-toggle="popover" data-bs-placement="top" title data-bs-content="top by popover" data-original-title="tooltip on top">Top
</button>
<button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="popover" data-bs-placement="left" title="tooltip on left" data-bs-content="left by popover">Left
</button>
<button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="popover" data-bs-placement="right" title="tooltip on right" data-bs-content="right by popover">right
</button>
<button type="button" class="btn btn-warning waves-effect waves-light" data-bs-toggle="popover" data-bs-placement="bottom" title="tooltip on bottom" data-bs-content="bottom by popover">bottom
</button>
<button type="button" class="btn btn-info waves-effect waves-light" data-bs-toggle="popover" data-html="true" data-bs-placement="top" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>" data-bs-content="tooltip by HTML">Html Tooltip
</button>
</div>
</div>
...
<div class="card-block tooltip-icon button-list">
<div class="input-group">
<span class="input-group-text addon-style" id="name">
<label class>
<i class="icofont icofont-user-alt-3"></i>
</label>
</span>
<input type="text" class="form-control" placeholder="Enter your name" title="Enter your name" data-bs-toggle="tooltip">
</div>
<div class="input-group">
<span class="input-group-text addon-style" id="name">
<label class>
...
<input type="text" class="form-control" placeholder="Enter email" title="Enter email" data-bs-toggle="tooltip">
</div>
<button type="button" class="btn btn-primary waves-effect waves-light m-r-20" data-bs-toggle="tooltip" data-placement="right" title="submit">Submit
</button>
</div>
</div>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/tooltip.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:50 GMT -->
</html>
