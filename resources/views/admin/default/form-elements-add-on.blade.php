...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-elements-add-on.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:05 GMT -->
<head>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Simple Add-on</label>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Placeholder</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style" id="basic-addon2">
<label class>%</label>
</span>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Right Add-on</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<input type="text" class="form-control" placeholder="Right addon">
<span class="input-group-text addon-style" id="basic-addon3">
<label class>$</label>
</span>
</div>
</div>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Both-side Add-on</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>$</label>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Muliple Add-ons</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>$</label>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Left Icon</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class><i class="icofont icofont-ui-volume"></i></label>
</span>
<input type="text" class="form-control" placeholder="Left addon">
</div>
</div>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Right Icon</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<input type="text" class="form-control" placeholder="Right addon">
<span class="input-group-text addon-style">
<label class><i class="icofont icofont-ui-wifi"></i></label>
</span>
</div>
</div>
</div>
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Both-side Icons Addon</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class><i class="icofont icofont-rounded-left"></i></label>
</span>
<input type="text" class="form-control" placeholder="Right add-on">
<span class="input-group-text addon-style">
<label class><i class="icofont icofont-rounded-right"></i></label>
</span>
</div>
</div>
</div>
...
<span class="input-group-text" style="background-color: #FFB64D;">
<label class="addon-color">
...
<span class="input-group-text" style="background-color: #d6d6d6;">
<label class>
...
<span class="input-group-text" style="background-color: #FF5370;">
<label class>
...
<span class="input-group-text" style="background-color: #2ed8b6;">
<label class>
...
<span class="input-group-text" style="background-color: #37474f;">
<label class>
...
<span class="input-group-text" style="background-color: #00bcd4;">
<label class>
...
<button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Left Action</button>
...
<div class="input-group input-group-dropdown">
<input type="text" class="form-control" aria-label="Text input with dropdown button">
<button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Right Action</button>
<div class="dropdown-menu">
<a class="dropdown-item" href="#!">Action</a>
<a class="dropdown-item" href="#!">Another action</a>
<a class="dropdown-item" href="#!">Something else</a>
...
<button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Click</button>
<div class="dropdown-menu">
<a class="dropdown-item" href="#!">Action</a>
<a class="dropdown-item" href="#!">Another action</a>
<a class="dropdown-item" href="#!">Something else</a>
...
<div class="col-sm-12">
<div class="input-group">
<div class="input-group-text addon-style">
...
<form>
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Normal Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Bold Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Capitalize Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Uppercase Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Lowercase Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Varient Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Left-Align Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Center-Align Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">Right-Align Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
...
<div class="row">
<label class="form-label col-sm-4 col-lg-2 col-form-label">RTL Text</label>
<div class="col-sm-8 col-lg-10">
<div class="input-group">
<span class="input-group-text addon-style">
<label class>
