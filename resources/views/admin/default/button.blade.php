...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/button.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:16 GMT -->
<head>
...
Button</button>
<button class="btn btn-disabled disabled waves-effect waves-light">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<p> Add <code>.btn-round</code> to default button to get rounded
corners.</p>
<button class="btn btn-primary btn-round waves-effect waves-light">Primary
Button</button>
<button class="btn btn-success btn-round waves-effect waves-light">Success
Button</button>
<button class="btn btn-info btn-round waves-effect waves-light">Info
Button</button>
<button class="btn btn-warning btn-round waves-effect waves-light">Warning
Button</button>
<button class="btn btn-danger btn-round waves-effect waves-light">Danger
Button</button>
<button class="btn btn-inverse btn-round waves-effect waves-light">Inverse
Button</button>
<button class="btn btn-disabled btn-round disabled waves-effect waves-light">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<p> Add <code>.btn-square</code> to default button to get square
corners.</p>
<button class="btn waves-effect waves-light btn-primary btn-square">Primary
Button</button>
<button class="btn waves-effect waves-light btn-success btn-square">Success
Button</button>
<button class="btn waves-effect waves-light btn-info btn-square">Info
Button</button>
<button class="btn waves-effect waves-light btn-warning btn-square">Warning
Button</button>
<button class="btn waves-effect waves-light btn-danger btn-square">Danger
Button</button>
<button class="btn waves-effect waves-light btn-inverse btn-square">Inverse
Button</button>
<button class="btn waves-effect waves-light btn-disabled btn-square disabled">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<p> Add <code>.btn-skew</code> to default button to get skew
Buttons.</p>
<button class="btn waves-effect waves-light btn-primary btn-skew">Primary
Button</button>
<button class="btn waves-effect waves-light btn-success btn-skew">Success
Button</button>
<button class="btn waves-effect waves-light btn-info btn-skew">Info
Button</button>
<button class="btn waves-effect waves-light btn-warning btn-skew">Warning
Button</button>
<button class="btn waves-effect waves-light btn-danger btn-skew">Danger
Button</button>
<button class="btn waves-effect waves-light btn-inverse btn-skew">Inverse
Button</button>
<button class="btn waves-effect waves-light btn-disabled btn-skew disabled">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<div class="card-block">
<p>Use Class <code>.btn-out</code> inside button to make inner
solid Border Button.</p>
<button class="btn btn-out waves-effect waves-light btn-primary btn-square">Primary
Button</button>
<button class="btn btn-out waves-effect waves-light btn-success btn-square">Success
Button</button>
<button class="btn btn-out waves-effect waves-light btn-info btn-square">Info
Button</button>
<button class="btn btn-out waves-effect waves-light btn-warning btn-square">Warning
Button</button>
<button class="btn btn-out waves-effect waves-light btn-danger btn-square">Danger
Button</button>
<button class="btn btn-out waves-effect waves-light btn-inverse btn-square">Inverse
Button</button>
<button class="btn btn-out waves-effect waves-light btn-disabled btn-square disabled">Disabled
Button</button>
<p>Use Class <code>.btn-out-dashed</code> inside button to make
inner dashed Border Button.</p>
<button class="btn btn-out-dashed waves-effect waves-light btn-primary btn-square">Primary
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-success btn-square">Success
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-info btn-square">Info
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-warning btn-square">Warning
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-danger btn-square">Danger
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-inverse btn-square">Inverse
Button</button>
<button class="btn btn-out-dashed waves-effect waves-light btn-disabled btn-square disabled">Disabled
Button</button>
<p>Use Class <code>.btn-out-dotted</code> inside button to make
inner solid dotted Button.</p>
<button class="btn btn-out-dotted waves-effect waves-light btn-primary btn-square">Primary
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-success btn-square">Success
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-info btn-square">Info
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-warning btn-square">Warning
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-danger btn-square">Danger
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-inverse btn-square">Inverse
Button</button>
<button class="btn btn-out-dotted waves-effect waves-light btn-disabled btn-square disabled">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<p>Use Class <code>.btn-grd-*</code> inside button to make
gradient Button.</p>
<button class="btn waves-effect waves-light btn-grd-primary ">Primary
Button</button>
<button class="btn waves-effect waves-light btn-grd-success">Success
Button</button>
<button class="btn waves-effect waves-light btn-grd-info ">Info
Button</button>
<button class="btn waves-effect waves-light btn-grd-warning ">Warning
Button</button>
<button class="btn waves-effect waves-light btn-grd-danger ">Danger
Button</button>
<button class="btn waves-effect waves-light btn-grd-inverse ">Inverse
Button</button>
<button class="btn waves-effect waves-light btn-grd-disabled btn-disabled disabled">Disabled
Button</button>
<h4 class="sub-title">Horizontal gradient</h4>
<p>Use Class <code>.hor-grd .btn-grd-*</code> inside button to
make horizontal gradient Button.</p>
<button class="btn waves-effect waves-light hor-grd btn-grd-primary ">Primary
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-success">Success
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-info ">Info
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-warning ">Warning
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-danger ">Danger
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-inverse ">Inverse
Button</button>
<button class="btn waves-effect waves-light hor-grd btn-grd-disabled btn-disabled disabled">Disabled
Button</button>
</div>
</div>
<div class="card">
...
<div class="card-block">
<p>Use Class <code>.btn-mat</code> inside button to make
matrialized Button.</p>
<button class="btn btn-mat waves-effect waves-light btn-primary ">Primary
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-success">Success
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-info ">Info
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-warning ">Warning
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-danger ">Danger
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-inverse ">Inverse
Button</button>
<button class="btn btn-mat waves-effect waves-light btn-disabled disabled">Disabled
Button</button>
</div>
</div>
</div>
...
<p>Use <code>&lt;i class="icofont icofont-star"&gt;</code>
inside button to add icon.</p>
<button class="btn waves-effect waves-light btn-primary"><i class="icofont icofont-user-alt-3"></i>Primary
Button</button>
<button class="btn waves-effect waves-light btn-success"><i class="icofont icofont-check-circled"></i>Success
Button</button>
<button class="btn waves-effect waves-light btn-info"><i class="icofont icofont-info-square"></i>Info
Button</button>
<button class="btn waves-effect waves-light btn-warning"><i class="icofont icofont-warning-alt"></i>Warning
Button</button>
<button class="btn waves-effect waves-light btn-danger"><i class="icofont icofont-eye-alt"></i>Danger
Button</button>
<button class="btn waves-effect waves-light btn-inverse"><i class="icofont icofont-exchange"></i>Inverse
Button</button>
<button class="btn waves-effect waves-light btn-disabled disabled"><i class="icofont icofont-not-allowed"></i>Disabled
Button</button>
</div>
</div>
</div>
...
<p>Use Class <code>btn-outline-*</code> inside button to make
Border Button.</p>
<button class="btn waves-effect waves-light btn-primary btn-outline-primary"><i class="icofont icofont-user-alt-3"></i>Primary
Button</button>
<button class="btn waves-effect waves-light btn-success btn-outline-success"><i class="icofont icofont-check-circled"></i>Success
Button</button>
<button class="btn waves-effect waves-light btn-info btn-outline-info"><i class="icofont icofont-info-square"></i>Info
Button</button>
<button class="btn waves-effect waves-light btn-warning btn-outline-warning"><i class="icofont icofont-warning-alt"></i>Warning
Button</button>
<button class="btn waves-effect waves-light btn-danger btn-outline-danger"><i class="icofont icofont-eye-alt"></i>Danger
Button</button>
<button class="btn waves-effect waves-light btn-inverse btn-outline-inverse"><i class="icofont icofont-exchange"></i>Inverse
Button</button>
<button class="btn waves-effect waves-light btn-disabled btn-outline-disabled disabled"><i class="icofont icofont-not-allowed"></i>Disabled
Button</button>
</div>
</div>
</div>
...
<button class="btn btn-primary dropdown-toggle waves-effect waves-light " type="button" id="dropdown-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Primary</button>
...
<button class="btn btn-success dropdown-toggle waves-effect waves-light " type="button" id="dropdown-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Success</button>
...
<button class="btn btn-info dropdown-toggle waves-effect waves-light " type="button" id="dropdown-4" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Info</button>
...
<button class="btn btn-warning dropdown-toggle waves-effect waves-light " type="button" id="dropdown-5" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Warning</button>
...
<button class="btn btn-danger dropdown-toggle waves-effect waves-light " type="button" id="dropdown-6" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Danger</button>
...
<button class="btn btn-inverse dropdown-toggle waves-effect waves-light " type="button" id="dropdown-7" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Inverse</button>
...
<button class="btn btn-disabled dropdown-toggle waves-effect waves-light disabled" type="button" id="dropdown-8" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Disabled</button>
...
<button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<span class="visually-hidden">Toggle primary</span>
</button>
<div class="dropdown-menu">
<a class="dropdown-item waves-effect waves-light" href="#">Action</a>
...
<button type="button" class="btn btn-danger dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<span class="visually-hidden">Toggle primary</span>
</button>
<div class="dropdown-menu">
<a class="dropdown-item waves-effect waves-light" href="#">Action</a>
...
<button type="button" class="btn btn-inverse dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<span class="visually-hidden">Toggle primary</span>
</button>
<div class="dropdown-menu">
<a class="dropdown-item waves-effect waves-light" href="#">Action</a>
...
<button type="button" class="btn btn-disabled disabled dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<span class="visually-hidden">Toggle primary</span>
</button>
<div class="dropdown-menu">
<a class="dropdown-item waves-effect waves-light" href="#">Action</a>
...
<p>Use <code>btn-xlg, btn-lg, btn-md, btn-sm, btn-mini</code>
inside class to use different size button.</p>
<div>
<div class="btn-group " role="group" data-bs-toggle="tooltip" data-placement="top" title data-original-title=".btn-xlg">
...
<button class="btn waves-effect waves-light btn-primary ">Default
Button</button>
<button class="btn waves-effect waves-light btn-primary btn-outline-primary "><i class="icofont icofont-user-alt-3"></i>Border
Button</button>
</div>
</div>
<div class="col-lg-6 col-md-12">
...
<div class="d-grid gap-2">
<button class="btn waves-effect waves-light btn-success btn-square ">Square
Button</button>
<button class="btn waves-effect waves-light btn-info btn-round ">Rounded
Button</button>
</div>
</div>
</div>
