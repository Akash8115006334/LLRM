...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/label-badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:44 GMT -->
<head>
...
<p>Use class <code>bg-default</code></p>
<div>
<label class="form-label badge bg-default">5</label>
<label class="form-label badge bg-default">9</label>
<label class="form-label badge bg-default">15</label>
</div>
</div>
</div>
...
<p>Use class <code>bg-primary</code></p>
<label class="form-label badge bg-primary">5</label>
<label class="form-label badge bg-primary">9</label>
<label class="form-label badge bg-primary">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<p>Use class <code>bg-success</code></p>
<label class="form-label badge bg-success">5</label>
<label class="form-label badge bg-success">9</label>
<label class="form-label badge bg-success">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<p>
Use class <code>bg-warning</code>
</p>
<label class="form-label badge bg-warning">5</label>
<label class="form-label badge bg-warning">9</label>
<label class="form-label badge bg-warning">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge bg-danger">5</label>
<label class="form-label badge bg-danger">9</label>
<label class="form-label badge bg-danger">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<p>
Use class <code>bg-info</code>
</p>
<label class="form-label badge bg-info ">5</label>
<label class="form-label badge bg-info">9</label>
<label class="form-label badge bg-info">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-default">5</label>
<label class="form-label badge badge-inverse-default">9</label>
<label class="form-label badge badge-inverse-default">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-primary">5</label>
<label class="form-label badge badge-inverse-primary">9</label>
<label class="form-label badge badge-inverse-primary">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-success">5</label>
<label class="form-label badge badge-inverse-success">9</label>
<label class="form-label badge badge-inverse-success">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-warning">5</label>
<label class="form-label badge badge-inverse-warning">9</label>
<label class="form-label badge badge-inverse-warning">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-danger">5</label>
<label class="form-label badge badge-inverse-danger">9</label>
<label class="form-label badge badge-inverse-danger">15</label>
</div>
</div>
<div class="col-lg-4 col-xl-3 col-sm-6">
<div class="badge-box">
...
<label class="form-label badge badge-inverse-info">5</label>
<label class="form-label badge badge-inverse-info">9</label>
<label class="form-label badge badge-inverse-info">15</label>
</div>
</div>
</div>
</div>
...
<label class="form-label label label-default">Default Label</label>
</div>
<div class="label-main">
<label class="form-label label label-primary">Primary Label</label>
</div>
<div class="label-main">
<label class="form-label label label-success">Success Label</label>
</div>
<div class="label-main">
<label class="form-label label label-info">Info Label</label>
</div>
<div class="label-main">
<label class="form-label label label-warning">Warning Label</label>
</div>
<div class="label-main">
<label class="form-label label label-danger">Danger Label</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse">Inverse Label</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-default">Border Default</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-primary">Border Primary</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-success">Border Success</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-info">Border Label</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-warning">Border Warning</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-danger">Border Danger</label>
</div>
<div class="label-main">
<label class="form-label label label-inverse-info-border">Border Inverse</label>
</div>
</div>
</div>
</div>
...
<div class="label-main">
<label class="form-label label label-lg label-primary">Large Label</label>
</div>
<div class="label-main">
<label class="form-label label label-md label-primary">Medium Label</label>
</div>
<div class="label-main">
<label class="form-label label label-primary">Default Label</label>
</div>
</div>
</div>
...
<label class="form-label badge badge-lg bg-info">5</label>
<label class="form-label badge badge-lg bg-info">5</label>
<label class="form-label badge badge-lg bg-info m-r-20">5</label>
</div>
<div class="group-label d-inline-block">
<label class="form-label badge badge-md bg-success">5</label>
<label class="form-label badge badge-md bg-success">5</label>
<label class="form-label badge badge-md bg-success m-r-20">5</label>
</div>
<div class="group-label d-inline-block">
<label class="form-label badge bg-danger">5</label>
<label class="form-label badge bg-danger">5</label>
...
<button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".btn-primary.badge">Primary
<span class="badge">90</span>
</button>
<button type="button" class="btn btn-success waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".btn-success.badge">success
<span class="badge">70</span>
</button>
<button type="button" class="btn btn-warning waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".btn-warning.badge">warning
<span class="badge">170</span>
</button>
<button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".btn-danger.badge">danger
<span class="badge">07</span>
</button>
<button type="button" class="btn btn-info waves-effect waves-light" data-bs-toggle="tooltip" data-placement="top" title=".btn-info.badge">info
...
<div class="card-header">
<div class="card-header-left">
<h5 class="card-header-text">Badges With Icon</h5>
</div>
</div>
<div class="card-block">
<div class="row">
...
<a href class="float-end" data-bs-toggle="modal" data-bs-target="#top-left-Modal">
</a>
</div>
...
<label class="form-label badge bg-default badge-top-left">5</label>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<a href class="float-end" data-bs-toggle="modal" data-bs-target="#top-right-Modal">
</a>
</div>
...
<div class="label-icon">
<i class="icofont icofont-envelope"></i>
<label class="form-label badge bg-primary badge-top-right">9</label>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<a href class="float-end" data-bs-toggle="modal" data-bs-target="#bottom-left-Modal">
</a>
</div>
...
<div class="label-icon">
<i class="icofont icofont-envelope"></i>
<label class="form-label badge bg-success badge-bottom-left">9</label>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<a href class="float-end" data-bs-toggle="modal" data-bs-target="#bottom-right-Modal">
</a>
</div>
...
<div class="label-icon">
<i class="icofont icofont-envelope"></i>
<label class="form-label badge bg-warning badge-bottom-right">5</label>
</div>
</div>
</div>
</div>
