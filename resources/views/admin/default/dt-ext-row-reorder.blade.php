...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-row-reorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:28 GMT -->
<head>
...
<li class="breadcrumb-item"><a href="#!">Rows Reorder</a>
</li>
</ul>
</div>
</div>
...
<span>This example shows RowReorder being used with the Responsive extension for DataTables and also that it provides support for touch inputs to perform a row reorder. Responsive is particularly useful with mobile devices, but can also be useful on desktops where complex data sets are shown in the DataTable. Note that the row reordering in this example is triggered by dragging the cells in the second column.</span>
</div>
<div class="card-block">
<div class="dt-responsive table-responsive">
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-row-reorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:30 GMT -->
</html>
