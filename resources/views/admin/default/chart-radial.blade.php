...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/chart-radial.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:19:29 GMT -->
<head>
...
<span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
<div class="card-block">
<div data-label="50%" data-bs-toggle="tooltip" class="radial-bar radial-bar-50 radial-bar-lg " data-title="50%"></div>
<div data-label="40%" data-bs-toggle="tooltip" class="radial-bar radial-bar-40 radial-bar-lg" data-title="40%"></div>
<div data-label="30%" data-bs-toggle="tooltip" class="radial-bar radial-bar-30 radial-bar-lg" data-title="30%"></div>
</div>
</div>
</div>
