...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-api.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:01 GMT -->
<head>
...
<span>This example shows a modification of the multiple row selection example, where just a single can now be selected. This is done simply by checking to see if the row already has a selected class or not, and if so removing it, if not then the class is removed from any other row in the table which does have it and applied to the row to be selected.</span>
</div>
<div class="card-block">
...
<div class="card-header">
<h5>Form Inputs</h5>
<span>In order to perform paging, ordering, searching etc, DataTables can remove rows and cells from the document (i.e. those rows / cells which are not needed are not inserted into the document). This increases performance and compatibility, however, it means that submitting forms which span multiple pages requires a little bit of additional work to get the information that is not in the document any longer.</span>
</div>
<div class="card-block">
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col0_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col0_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col1_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col1_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col2_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col2_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col3_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col3_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col4_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col4_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col5_regex">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
...
<div class="checkbox-fade fade-in-primary m-0">
<label class="form-label">
<input type="checkbox" class="global_filter" id="col5_smart" checked="checked">
<span class="cr">
<i class="cr-icon icofont icofont-ui-check txt-primary"></i>
</span>
</label>
