...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/icon-font-awesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:03 GMT -->
<head>
...
<h5>27 New Icons <label class="form-label label bg-success"> New </label> </h5>
<span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span>
</div>
...
<label class="form-label txt-ellipsis"> fa-angellist</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-area-chart"></i>
<label class="form-label txt-ellipsis"> fa-area-chart</label>
</div>
...
<label class="form-label txt-ellipsis"> fa-file</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-archive-o"></i>
<label class="form-label txt-ellipsis"> fa-file-archive-o</label>
</div>
...
<label class="form-label txt-ellipsis"> fa-file-o</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-pdf-o"></i>
<label class="form-label txt-ellipsis"> fa-file-pdf-o</label>
</div>
...
<label class="form-label txt-ellipsis"> fa-file-text</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-text-o"></i>
<label class="form-label txt-ellipsis"> fa-file-text-o</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-video-o"></i>
<label class="form-label txt-ellipsis"> fa-file-video-o</label>
</div>
...
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-zip-o"></i>
<label class="form-label txt-ellipsis"> fa-file-zip-o <span class="text-muted">(alias)</span></label>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-circle-o-notch"></i>
<label class="form-label txt-ellipsis">cog</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-cog"></i>
<label class="form-label txt-ellipsis"> fa-file-archive-o</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-gear"></i>
<label class="form-label txt-ellipsis"> gear </label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-refresh"></i>
<label class="form-label txt-ellipsis"> refresh</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-spinner"></i>
<label class="form-label txt-ellipsis"> spinner</label>
</div>
</div>
</div>
</div>
...
<label class="form-label txt-ellipsis"> fa-bitcoin <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-btc"></i>
<label class="form-label txt-ellipsis"> fa-btc</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-cny"></i>
<label class="form-label txt-ellipsis"> fa-cny <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dollar"></i>
<label class="form-label txt-ellipsis"> fa-dollar <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-eur"></i>
<label class="form-label txt-ellipsis"> fa-eur</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-euro"></i>
<label class="form-label txt-ellipsis"> fa-euro <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-gbp"></i>
<label class="form-label txt-ellipsis"> fa-gbp</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-inr"></i>
<label class="form-label txt-ellipsis"> fa-inr</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-jpy"></i>
<label class="form-label txt-ellipsis"> fa-jpy</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-krw"></i>
<label class="form-label txt-ellipsis"> fa-krw</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-money"></i>
<label class="form-label txt-ellipsis"> fa-money</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rmb"></i>
<label class="form-label txt-ellipsis"> fa-rmb <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rouble"></i>
<label class="form-label txt-ellipsis"> fa-rouble <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rub"></i>
<label class="form-label txt-ellipsis"> fa-rub</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-ruble"></i>
<label class="form-label txt-ellipsis"> fa-ruble <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rupee"></i>
<label class="form-label txt-ellipsis"> fa-rupee <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-try"></i>
<label class="form-label txt-ellipsis"> fa-try</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-turkish-lira"></i>
<label class="form-label txt-ellipsis"> fa-turkish-lira <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-usd"></i>
<label class="form-label txt-ellipsis"> fa-usd</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-won"></i>
<label class="form-label txt-ellipsis"> fa-won <span class="text-muted">(alias)</span>
</label>
</div>
<div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-yen"></i>
<label class="form-label txt-ellipsis"> fa-yen <span class="text-muted">(alias)</span>
</label>
</div>
</div>
...
<script type="text/javascript" src="../files/assets/pages/icon-modal.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/icon-font-awesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:04 GMT -->
</html>
