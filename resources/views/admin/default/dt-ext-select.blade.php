...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:33 GMT -->
<head>
...
<li class="breadcrumb-item"><a href="#!">Select Initialization</a>
</li>
</ul>
</div>
</div>
...
<span>Select has the ability to select rows, columns and / or cells in a table. Row selection is the default behavior as it is the most commonly used selection item type, but the items to be selected can be easily changed using the select.items initialization option, or after initialization using the select.items() API method.</span>
</div>
<div class="card-block">
<div class="dt-responsive table-responsive">
...
<span>A selected row is typically shown in a DataTable by using a highlight background colour - however, it can also be useful to use other styling options to convey the selected state of items in a table to the end user.</span>
</div>
<div class="card-block">
<div class="dt-responsive table-responsive">
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:36 GMT -->
</html>
