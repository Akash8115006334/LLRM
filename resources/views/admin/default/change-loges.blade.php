...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/change-loges.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:20:50 GMT -->
<head>
...
<meta name="description" content="Admindek Bootstrap admin template made using 5 and it has huge amount of ready made feature, UI components, pages which completely fulfills any dashboard needs." />
...
<li class="breadcrumb-item"><a href="#!">Changelog</a>
</li>
</ul>
</div>
</div>
...
<i class="icofont icofont-life-buoy"></i> Item support
</a>
</div>
</div>
...
<label class="form-label label label-info">V.1.2</label>
</div>
</div>
<div class="card-block">
<p class="content-group">Version 1.2 is a quick update that contains some reported bugs fixes and plugins update. Nothing new is added since this is an addition to global 1.2 version. Important milestone for 1.3
version is footer and container height enhancements - jquery solution for calculating minimum container height will be replaced with pure CSS.</p>
...
<label class="form-label label label-info">V.1.1</label>
</div>
</div>
<div class="card-block">
<p class="content-group">First update is the most simplified and includes urgent bug fixes of core components, plugins and libraries. Also version 1.1 includes updates of some components to the latest stable versions.
The only new thing here is RTL version of all 4 layouts, that support almost all available components and layout features. Below you can find general list of all changes and details about
upgrading.
</p>
<pre class="language-javascript">
                                      <code>
