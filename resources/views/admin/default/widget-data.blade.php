...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:01 GMT -->
<head>
...
<td>HeadPhone</td>
<td>
<img src="../files/assets/images/widget/p1.jpg" alt class="img-fluid img-20">
</td>
<td>
...
<td>Iphone 6</td>
<td>
<img src="../files/assets/images/widget/p2.jpg" alt class="img-fluid img-20"></td>
<td>
<div class="p-status bg-c-green"></div>
</td>
<td>$20</td>
...
<td>Jacket</td>
<td>
<img src="../files/assets/images/widget/p3.jpg" alt class="img-fluid img-20">
</td>
<td>
<div class="p-status bg-c-green"></div>
</td>
...
<td>Sofa</td>
<td>
<img src="../files/assets/images/widget/p4.jpg" alt class="img-fluid img-20">
</td>
<td>
<div class="p-status bg-c-green"></div>
</td>
...
<td>Iphone 6</td>
<td>
<img src="../files/assets/images/widget/p2.jpg" alt class="img-fluid img-20">
</td>
<td>
<div class="p-status bg-c-green"></div>
</td>
...
<td>23/05/2017</td>
<td>04/08/2018</td>
<td><label class="form-label label label-success">Paid</label></td>
</tr>
<tr>
<td>Envato Pvt Ltd.</td>
<td>20/03/2017</td>
<td>04/08/2019</td>
<td><label class="form-label label label-danger">Unpaid</label></td>
</tr>
<tr>
...
<td class="text-end">
<label class="form-label label label-warning">43%</label>
</td>
</tr>
<tr>
<td>
...
<td class="text-end">
<label class="form-label label label-success">58%</label>
</td>
</tr>
<tr>
<td>
...
<td class="text-end">
<label class="form-label label label-danger">30%</label>
</td>
</tr>
<tr>
<td>
...
<td>19-11-2018</td>
<td>
<label class="form-label badge badge-inverse-primary">Sketch</label>
<label class="form-label badge badge-inverse-primary">Ui</label>
</td>
...
<td>19-11-2018</td>
<td>
<label class="form-label badge badge-inverse-primary">Ux</label>
<label class="form-label badge badge-inverse-danger">Ui</label>
<label class="form-label badge badge-inverse-danger">php</label>
</td>
<td><a href="#!"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a><a href="#!"><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a></td>
</tr>
<tr>
...
<td>16-03-2018</td>
<td>
<label class="form-label badge badge-inverse-danger">Sketch</label>
<label class="form-label badge badge-inverse-primary">Ui</label>
</td>
<td><a href="#!"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a><a href="#!"><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a></td>
</tr>
...
<td>
<label class="form-label badge badge-inverse-primary">Ux</label>
<label class="form-label badge badge-inverse-success">Ui</label>
<label class="form-label badge badge-inverse-warning">php</label>
</td>
<td><a href="#!"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a><a href="#!"><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a></td>
</tr>
<tr>
...
<img src="../files/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
</div>
<div class="col">
<h6 class="m-b-15">John Deo</h6>
...
<div class="col">
<h6 class="m-b-0">3.2</h6></div>
</div>
<p class="m-t-15 m-b-0 text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
</div>
</div>
<div class="row">
<div class="col-sm-auto p-r-0">
<img src="../files/assets/images/avatar-1.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
</div>
<div class="col">
<h6 class="m-b-15">John Deo</h6>
<div class="row align-items-center">
...
<td>Sofa</td>
<td>#PHD001</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9dfcfffeddfaf0fcf4f1b3fef2f0">[email&#160;protected]</a></td>
...
<td>Computer</td>
<td>#PHD002</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5c6c1c6e5c2c8c4ccc98bc6cac8">[email&#160;protected]</a></td>
...
<td>Mobile</td>
<td>#PHD003</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6c1c1d1e2c0b010d0500420f0301">[email&#160;protected]</a></td>
<td><label class="form-label label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Coat</td>
<td>#PHD004</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="afcdccdcefc8c2cec6c381ccc0c2">[email&#160;protected]</a></td>
<td><label class="form-label label label-success">In Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Watch</td>
<td>#PHD005</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2043444360474d41494c0e434f4d">[email&#160;protected]</a></td>
<td><label class="form-label label label-success">In Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Shoes</td>
<td>#PHD006</td>
<td><a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6e1e1f1c2e09030f0702400d0103">[email&#160;protected]</a></td>
<td><label class="form-label label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Software pro</td>
<td>Task</td>
<td><label class="form-label label label-danger">Open</label></td>
<td>Ken Malit</td>
<td>Normal</td>
<td>7/8/2017</td>
<td>8/9/2018</td>
...
<td>Software pro</td>
<td>Task</td>
<td><label class="form-label label label-primary">New</label></td>
<td>Ken Malit</td>
<td>Normal</td>
<td>7/8/2017</td>
<td>8/9/2018</td>
...
<td>Software pro</td>
<td>Task</td>
<td><label class="form-label label label-success">Close</label></td>
<td>Ken Malit</td>
<td>Normal</td>
<td>7/8/2017</td>
<td>8/9/2018</td>
...
<div class="col">
<a href="#!"><h6 class="m-b-5">You have 3 pending tasks. <span class="text-muted float-end f-14">Just Now</span></h6></a>
</div>
</div>
<div class="row m-b-30 align-items-center">
<div class="col-auto p-r-0">
...
<div class="col">
<a href="#!"><h6 class="m-b-5">New order received <span class="text-muted float-end f-14">Just Now</span></h6></a>
</div>
</div>
<div class="row m-b-30 align-items-center">
<div class="col-auto p-r-0">
...
<p class="m-b-10">New Dashboard <span class="float-end text-muted f-14">5 Mins ago</span></p>
<ul class="list-unstyled m-b-20">
<li class="d-inline-block"><img src="../files/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="../files/assets/images/avatar-3.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="../files/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
</ul>
<p class="m-b-10 ">Web Design <span class="float-end text-muted f-14">8 Mins ago</span></p>
<ul class="list-unstyled  m-b-20">
<li class="d-inline-block"><img src="../files/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="../files/assets/images/avatar-3.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
</ul>
<p class="m-b-10">Android Design <span class="float-end text-muted f-14">12 Mins ago</span></p>
<ul class="list-unstyled m-b-20">
<li class="d-inline-block"><img src="../files/assets/images/avatar-4.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="../files/assets/images/avatar-2.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
<li class="d-inline-block"><img src="../files/assets/images/avatar-3.jpg" alt="user-image" class="img-radius img-30 m-r-15" data-bs-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
</ul>
<p class="m-b-10">New Dashboard <span class="float-end text-muted f-14">5 Mins ago</span></p>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/widget-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:08 GMT -->
</html>
