...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/menu-horizontal-icon-fixed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:14:42 GMT -->
<head>
...
<span>
Horizontal Fixed with icon layout is useful for those users who only wants menu options on top.
</span>
</div>
</div>
<div class="card">
...
<div class="card-block">
<span>To use Compact Menu for your project add <code><strong>themelayout: 'horizontal', FixedNavbarPosition: true, FixedHeaderPosition: true,</strong></code> class in js.</span>
</div>
</div>
<div class="card">
<div class="card-header">
...
<div class="card-block">
<p>Use the following code to use <strong>Horizontal Fixed Layout with Icon</strong> in horizontal.</p>
...
<script src="../files/assets/js/vertical/menu/menu-hori-fixed.js"></script>
