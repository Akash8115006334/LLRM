...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:30 GMT -->
<head>
...
<select name="select" class="form-select form-control form-control-success">
<option value="opt1">Select One Value Only</option>
<option value="opt2">Type 2</option>
<option value="opt3">Type 3</option>
<option value="opt4">Type 4</option>
...
<select name="select" class="form-select form-control form-control-info">
<option value="opt1">Select One Value Only</option>
<option value="opt2">Type 2</option>
<option value="opt3">Type 3</option>
<option value="opt4">Type 4</option>
...
<select name="select" class="form-select form-control form-control-warning">
<option value="opt1">Select One Value Only</option>
<option value="opt2">Type 2</option>
<option value="opt3">Type 3</option>
<option value="opt4">Type 4</option>
...
<select name="select" class="form-select form-control form-control-danger">
<option value="opt1">Select One Value Only</option>
<option value="opt2">Type 2</option>
<option value="opt3">Type 3</option>
<option value="opt4">Type 4</option>
...
<select name="select" class="form-select form-control form-control-inverse">
<option value="opt1">Select One Value Only</option>
<option value="opt2">Type 2</option>
<option value="opt3">Type 3</option>
<option value="opt4">Type 4</option>
...
<select class="form-select js-example-basic-single col-sm-12">
...
<select class="form-select js-example-basic-multiple col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
...
<select class="form-select js-example-tags col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-tokenizer col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-rtl col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-basic-multiple-limit col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-diacritics col-sm-12" multiple="multiple">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-responsive col-sm-12" multiple="multiple" style="width:75%;">
<option value="AL">Alabama</option>
<option value="WY">Wyoming</option>
<option value="WY">Coming</option>
<option value="WY">Hanry Die</option>
...
<select class="form-select js-example-disabled-results col-sm-12">
...
<select class="form-select js-example-basic-hide-search col-sm-12" multiple="multiple" style="width: 75%">
<optgroup label="Developer">
...
<select class="form-select js-example-disabled col-sm-8">
<option value="AL">Smith</option>
<option value="WY">Peter</option>
<option value="WY">James</option>
<option value="WY">Hanry Die</option>
...
<select id="hello-single" class="form-select form-control">
...
<select id="hello-single-2" class="form-select form-control">
<option value="cheese">Cheese</option>
<option value="h">Hanry Die</option>
<option value="c">Come Leo</option>
<option value="h">Hampri Catlin</option>
...
<select id="hello-single-3" class="form-select form-control">
<option value="cheese">Cheese</option>
<option value="h">Hanry Die</option>
<option value="c">Come Leo</option>
<option value="h">Hampri Catlin</option>
...
<select class="form-select" multiple="multiple" id="my-select" name="my-select[]">
...
<select class="form-select" id="custom-headers1" multiple="multiple">
...
<select class="form-select" id="optgroup" multiple="multiple">
...
<select id="custom-headers" class="form-select searchable" multiple="multiple">
<option value="elem_1" selected>elem 1</option>
<option value="elem_2">elem 2</option>
<option value="elem_3">elem 3</option>
...
<select class="form-select" id="public-methods" multiple="multiple">
<option value="elem_1">elem 1</option>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:38 GMT -->
</html>
