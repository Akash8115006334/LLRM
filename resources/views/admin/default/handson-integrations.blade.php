...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/handson-integrations.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:19:02 GMT -->
<head>
...
<div class="d-inline">
<h5>HandsonTable Integrations</h5>
...
<li class="breadcrumb-item"><a href="#!">Integrations</a>
</li>
</ul>
</div>
</div>
...
<h5>Jquery</h5>
<span>jQuery is a library, which makes DOM manipulations and event handling easier. Handson table is fully compatible with jQuery - the small example below shows that the integration between the two is quick and intuitive. In order to use Handson table as a jQuery plugin, you need to do some basic preparation:</span>
</div>
<div class="card-block">
<div class="table-responsive scroll-container">
<div id="jQuery" class="hot handsontable htRowHeaders htColumnHeaders"></div>
</div>
</div>
</div>
...
<div class="card-header">
<h5>ChromaJS</h5>
<span>The following demo shows an example of using heatmaps for the values in the grid's columns. Changing the values in the grid automatically recalculates the font color for the whole column, thereby updating a heatmap. The dynamic color scale calculation is done using the excellent Chroma.js.</span>
</div>
<div class="card-block">
<div class="table-responsive scroll-container">
<div id="chromaJS" class="hot handsontable htRowHeaders htColumnHeaders"></div>
</div>
</div>
</div>
...
<script type="text/javascript" src="../files/assets/pages/handson-table/chroma.min.js"></script>
<script type="text/javascript" src="../files/assets/pages/handson-table/integration.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/handson-integrations.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:19:04 GMT -->
</html>
