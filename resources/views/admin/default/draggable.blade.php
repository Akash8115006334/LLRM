...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/draggable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:52 GMT -->
<head>
...
<div class="card-sub">
<img class="card-img-top img-fluid" src="../files/assets/images/card-block/card1.jpg" alt="Card image cap">
<div class="card-block">
...
<div class="col-lg-12 col-xl-3">
<div class="card-sub">
<img class="card-img-top img-fluid" src="../files/assets/images/card-block/card14.jpg" alt="Card image cap">
<div class="card-block">
...
<div class="col-lg-12 col-xl-3">
<div class="card-sub">
<img class="card-img-top img-fluid" src="../files/assets/images/card-block/card13.jpg" alt="Card image cap">
<div class="card-block">
...
<div class="col-lg-12 col-xl-3">
<div class="card-sub">
<img class="card-img-top img-fluid" src="../files/assets/images/card-block/card2.jpg" alt="Card image cap">
<div class="card-block">
...
<img class="img-fluid p-absolute" src="../files/assets/images/avatar-1.jpg" alt>
...
<div class="sortable-moves card-sub">
<img class="img-fluid p-absolute" src="../files/assets/images/avatar-2.jpg" alt>
<h5 class="card-title">Multiple list 1</h5>
<p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
</div>
<div class="sortable-moves card-sub">
<img class="img-fluid p-absolute" src="../files/assets/images/avatar-3.jpg" alt>
<h5 class="card-title">Multiple list 2</h5>
<p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
</div>
<div class="sortable-moves card-sub">
<img class="img-fluid p-absolute" src="../files/assets/images/avatar-4.jpg" alt>
<h5 class="card-title">Multiple list 3</h5>
<p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
</div>
<div class="sortable-moves card-sub">
<img class="img-fluid p-absolute" src="../files/assets/images/avatar-5.jpg" alt>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/draggable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:59 GMT -->
</html>
