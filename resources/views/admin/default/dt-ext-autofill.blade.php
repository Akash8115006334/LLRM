...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:01 GMT -->
<head>
...
<li class="breadcrumb-item"><a href="#!">AutoFill Initialization</a>
</li>
</ul>
</div>
</div>
...
<span>AutoFill provides the ability to determine what columns it should be enabled upon through the autoFill.columns option. This will accept any value allowed by the column-selector data type, such as an array of column indexes, class names, or as shown in this case a jQuery selector.
</span>
</div>
<div class="card-block">
<div class="dt-responsive table-responsive">
...
<span>When dragging an AutoFill handle, the table (if DataTables scrolling is enabled) or the window will be automatically scrolled, as you approach the edge of the scrolling component. The example below shows the effect with DataTables scrolling (and also window if needed).
</span>
</div>
<div class="card-block">
<div class="dt-responsive table-responsive">
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/dt-ext-autofill.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:18:06 GMT -->
</html>
