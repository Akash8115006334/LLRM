...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/menu-horizontal-icon.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:14:42 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="../files/assets/css/pcoded-horizontal.min.html">
</head>
...
<span>
Horizontal Static with icon layout is useful for those users who don't wants menu options on top.
</span>
</div>
</div>
<div class="card">
...
<div class="card-block">
<span>To use static layout for your project add <code><strong>.horizontal-icon</strong></code> class in <code>body</code> tag.</span>
</div>
</div>
<div class="card">
<div class="card-header">
...
<div class="card-block">
<span>To use Compact Menu for your project add <code><strong>themelayout: 'horizontal', FixedNavbarPosition: false, FixedHeaderPosition: false,</strong></code> class in js.</span>
</div>
</div>
<div class="card">
<div class="card-header">
...
<div class="card-block">
<p>Use the following code to use <strong>Horizontal Static Layout with Icon</strong> in horizontal.</p>
