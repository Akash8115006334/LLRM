...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:20:42 GMT -->
<head>
...
<div class="docs-data">
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataX">X</label>
<input type="text" class="form-control" id="dataX" placeholder="x">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataY">Y</label>
<input type="text" class="form-control" id="dataY" placeholder="y">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataWidth">Width</label>
<input type="text" class="form-control" id="dataWidth" placeholder="width">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataHeight">Height</label>
<input type="text" class="form-control" id="dataHeight" placeholder="height">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataRotate">Rotate</label>
<input type="text" class="form-control" id="dataRotate" placeholder="rotate">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataScaleX">ScaleX</label>
<input type="text" class="form-control" id="dataScaleX" placeholder="scaleX">
</div>
<div class="input-group">
<label class="form-label form-label input-group-addon" for="dataScaleY">ScaleY</label>
...
<label class="form-label btn btn-primary btn-upload" for="inputImage" title="Upload image file">
<input type="file" class="visually-hidden" id="inputImage" name="file" accept="image/*">
...
<div class="d-grid">
<button type="button" class="btn btn-primary dropdown-toggle" id="toggleOptions" data-bs-toggle="dropdown" aria-expanded="true">
Toggle Options
</button>
</div>
...
<li role="presentation">
<label class="form-label form-label checkbox-inline">
...
<p class="content-group">This is the most basic example of <code>cropper</code>
implementation. By default cropping area is centered and takes 80% of image space. The image
is resizable, but should be wrapped in
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">This example demonstrates default options, but with hidden black
modal layer above the cropper. To hide the modal set <code>modal</code> option to
<code>false</code>. If visible, modal color
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">This example demonstrates cropped area that has
<code>fixed position</code> and can't be moved. Although it isn't movable, other options
remain available: resize, dragging, callbacks, aspect
ratios, modal etc.</p>
...
<div class="panel-body">
<p class="content-group">This example demonstrates cropped area that has
<code>fixed size</code> and can't be resized. Although it isn't resizable, other options
remain available: moving, dragging, callbacks, aspect
ratios, modal etc.</p>
<div class="image-cropper-container">
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">In this example cropping zone is not rendered automatically when
initialize and available only on a new drag. By default, cropping zone is always
<code>visible</code> and can be hidden by
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">In this example the user can't drag the image within container, but
can drag cropping area.. By default, this feature is disabled and can be enabled by setting
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">Thix example demonstrates fixed <code>16:9</code> dragging
(selection) ratio. By default, aspect ratio isn't specified and is free. Optional aspect
ratios are also available and can be specified
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">Thix example demonstrates fixed <code>4:3</code> dragging (selection)
ratio. By default, aspect ratio isn't specified and is free. Optional aspect ratios are also
available and can be specified
using <code>aspectRatio</code> option.</p>
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">This example demonstrates the <code>minimum</code> width and height
(px of original image) of the cropping zone. Better use this option only when you are sure
that the image has this <code>minimum</code> width and height. By default, both values
aren't specified.</p>
...
<div class="panel panel-flat">
<div class="panel-body">
<p class="content-group">This example demonstrates the ability to disable <code>zoom</code>
...
<script src="../files/bower_components/cropper/js/cropper.js"></script>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/image-crop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:20:47 GMT -->
</html>
