...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:16 GMT -->
<head>
...
<i class="icon feather icon-alert-octagon bg-c-blue"></i>
<div class="d-inline">
<h5>Alert</h5>
...
<div class="row">
<div class="col-sm-12 col-md-12 col-xl-6">
<div class="alert alert-default border-default alert-dismissible">
<strong>Default!</strong> add Class <code> border-default</code>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<div class="alert alert-primary border-primary alert-dismissible">
<strong>Primary!</strong> add Class <code> border-primary</code>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<div class="alert alert-success border-success alert-dismissible">
<strong>Success!</strong> add Class <code> border-success</code>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
</div>
<div class="col-sm-12 col-md-12 col-xl-6">
<div class="alert alert-info border-info alert-dismissible">
...
<div class="alert alert-danger border-danger alert-dismissible">
...
<div class="row">
<div class="col-sm-12 col-md-12 col-xl-6">
<div class="alert alert-default background-default alert-dismissible">
...
<div class="alert alert-warning background-warning alert-dismissible">
...
<div class="row">
<div class="col-sm-12 col-md-12 col-xl-6">
<div class="alert alert-default icons-alert alert-dismissible">
<strong>Default!</strong> Add Class <code>alert-default icons-alert</code>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<div class="alert alert-primary icons-alert alert-dismissible">
<p><strong>Primary!</strong> Add Class <code>alert-primary icons-alert</code></p>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<div class="alert alert-success icons-alert alert-dismissible">
<p><strong>Success!</strong> Add Class <code>alert-success icons-alert</code></p>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
</div>
<div class="col-sm-12 col-md-12 col-xl-6">
<div class="alert alert-info icons-alert alert-dismissible">
...
<div class="alert alert-danger icons-alert alert-dismissible">
