...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/navbar-light.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:14:42 GMT -->
<head>
...
<h5>Only Header Color</h5>
</div>
<div class="card-block">
<h4 class="sub-title">
header-theme="themelight1" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="themelight1"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav1.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme1" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme1"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav2.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme2" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme2"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav3.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme3" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme3"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav4.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme4" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme4"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav5.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme5" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme5"</code> attribute in <code>.pcoded-header</code> class</p>
<img src="../files/assets/images/navbar/nav6.jpg" class="img-fluid img-thumbnail" alt>
</div>
</div>
<div class="card">
<div class="card-header">
<h5>Full Header Color</h5>
</div>
<div class="card-block">
<h4 class="sub-title">
header-theme="theme1" & logo-theme="theme1"
</h4>
<p class="m-b-10">Add <code>header-theme="theme1"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme1"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav7.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme2" & logo-theme="theme2"
</h4>
<p class="m-b-10">Add <code>header-theme="theme2"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme2"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav8.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme3" & logo-theme="theme3"
</h4>
<p class="m-b-10">Add <code>header-theme="theme3"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme3"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav9.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme4" & logo-theme="theme4"
</h4>
<p class="m-b-10">Add <code>header-theme="theme4"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme4"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav10.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme5" & logo-theme="theme5"
</h4>
<p class="m-b-10">Add <code>header-theme="theme5"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme5"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav11.jpg" class="img-fluid img-thumbnail" alt>
<h4 class="sub-title m-t-30">
header-theme="theme6" & logo-theme="theme6"
</h4>
<p class="m-b-10">Add <code>header-theme="theme6"</code> attribute in <code>.pcoded-header</code> class</p>
<p class="m-b-10">Add <code>logo-theme="theme6"</code> attribute in <code>.navbar-logo</code> class</p>
<img src="../files/assets/images/navbar/nav12.jpg" class="img-fluid img-thumbnail" alt>
</div>
</div>
</div>
</div>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/navbar-light.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:14:55 GMT -->
</html>
