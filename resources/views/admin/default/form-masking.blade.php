...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-masking.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:38 GMT -->
<head>
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Insert Date 1</label>
</div>
<div class="col-sm-9">
...
<div class="mb-3 row">
<div class="col-sm-3">
<label class="form-label col-form-label">Insert Date 2</label>
</div>
<div class="col-sm-9">
...
<div class="mb-3 row">
<div class="col-sm-3">
<label class="form-label col-form-label">Hour</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Date & Hour</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Mobile No.</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Telephone</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Tel. with Code Area</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">US Telephone</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">IP Address</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">IPV4</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">IPV6</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Default</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Auto Numeric (%)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Maximum Value (0 - 9999)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Range Value (-99.99 - 1000.00)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Bracket Value</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Dollar ($)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Euro (€)</label>
</div>
<div class="col-sm-9">
<input type="text" class="form-control autonumber" data-a-sign="€">
</div>
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Rupee (Rs.)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Renminbi (¥)</label>
</div>
<div class="col-sm-9">
...
<div class="row mb-3">
<div class="col-sm-3">
<label class="form-label col-form-label">Pound (£)</label>
</div>
<div class="col-sm-9">
<input type="text" class="form-control autonumber" data-a-sign="£ ">
</div>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-masking.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:43 GMT -->
</html>
