...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/todo.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:20:30 GMT -->
<head>
...
<i class="feather icon-bookmark bg-c-blue"></i>
<div class="d-inline">
<h5>To Do</h5>
...
<label class="form-label float-label">Create your task list</label>
</div>
</form>
<div class="form-icon ">
...
<span class="float-end hidden-phone">
...
<div>
<a class="btn btn-primary btn-add-task waves-effect waves-light m-t-10" href="#" data-bs-toggle="modal" data-bs-target="#flipFlop"><i class="icofont icofont-plus"></i> Add New Tasks</a>
</div>
</div>
</section>
</div>
...
<input type="text" name="task-insert" class="form-control save_task_todo" required>
<span class="form-bar"></span>
<label class="form-label float-label">Create your task list</label>
</div>
</form>
