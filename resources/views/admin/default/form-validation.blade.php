...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:12 GMT -->
<head>
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Simple Input</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Repeat Password</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Radio Buttons</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Enter Username</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Enter Email-id</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Integers Only</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Numbers Only</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Greater number</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2 col-form-label">Less number</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2">Radio Buttons</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label class="form-label col-sm-2">Select Checkbox</label>
<div class="col-sm-10">
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:17:16 GMT -->
</html>
