...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:44 GMT -->
<head>
...
<a class="media-left" href="#">
<div class="flex-shrink-0">
<img class="media-object card-list-img" src="../files/assets/images/avatar-2.jpg" alt="Generic placeholder image">
</div>
</a>
<div class="flex-grow-1">
<div class="col-xs-12">
...
Heading</h6>
<label class="form-label label label-info">Agent</label>
</div>
...
<div class="m-t-15">
<button type="button" data-bs-toggle="tooltip" title="Facebook" class="btn btn-facebook btn-mini waves-effect waves-light">
<span class="icofont icofont-social-facebook"></span>
</button>
<button type="button" data-bs-toggle="tooltip" title="Twitter" class="btn btn-twitter btn-mini waves-effect waves-light">
<span class="icofont icofont-social-twitter"></span>
</button>
<button type="button" data-bs-toggle="tooltip" title="Linkedin" class="btn btn-linkedin btn-mini waves-effect waves-light">
<span class="icofont icofont-brand-linkedin"></span>
</button>
<button type="button" data-bs-toggle="tooltip" title="Drible" class="btn btn-dribbble btn-mini waves-effect waves-light">
...
<h6 class="d-inline-block">
Heading</h6>
<label class="label form-label label-info">Accountant</label>
</div>
<div class="f-13 text-muted m-b-15">
Softwear Engineer
</div>
...
<a class="media-left" href="#">
<div class="flex-shrink-0">
<img class="media-object card-list-img" src="../files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
</div>
</a>
<div class="flex-grow-1">
<div>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:15:49 GMT -->
</html>
