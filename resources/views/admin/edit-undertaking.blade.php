                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#home7" role="tab"><i
                                                                    class="feather icon-power"></i>Undertaking Image</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        ...
                                                        <div class="tab-pane active" id="home7" role="tabpanel">
                                                            <form
                                                                action="{{route('editUndertaking',['id' => $Undertaking->id])}}"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-block text-center">
                                                                                ...
                                                                                <img src="{{ Storage::url($Undertaking->image) }}"
                                                                                    alt="profile image"
                                                                                    style="width: 225px;">
