        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Other Facilities Page</h5>
                        <span>Here you can add,update and delete Other Facilities page slider image and Other Facilities
                            card image and
                            text
                            etc.</span>
                    </div>
                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>Other Facilities
                                                                Section Details</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link " data-bs-toggle="tab" href="#home7"
                                                                role="tab"><i class="feather icon-power"></i>Other Facilities
                                                                Details
                                                                Card</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('updateOtherFacilities')}}"
                                                                method="post">
                                                                @csrf
                                                                <input type="hidden" name="Id"
                                                                    value="{{ $FacilitiesSectionDetail->id ??'' }}">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    class="form-control"
                                                                                    value="{{ old('title', $FacilitiesSectionDetail->title ?? '' )}}"
                                                                                    required>
                                                                                @error('title')
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="subtitle"
                                                                                    ...
                                                                                    required>{{ old('subtitle', $FacilitiesSectionDetail->subtitle ?? '' )}}</textarea>
                                                                                @error('subtitle')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="additionalContent"
                                                                                    class="form-control" rows="2"
                                                                                    id="ckeditor"
                                                                                    required>{{ old('additionalContent', $FacilitiesSectionDetail->additionalContent ?? '' )}}</textarea>
                                                ...
                                                <div class="tab-pane" id="home7" role="tabpanel">
                                                    <form action="{{route('addOtherFacilities')}}" method="post"
                                                                ...
                                                                <div class=" ">
                                                                    <table
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            $sno = 0;
                                                                            @endphp
                                                                            @foreach ($FacilitiesCard as $card)
                                                                            @php
                                                                            $sno++;
                                                                            @endphp
                                                                            <tr>
                                                                                ...
                                                                                <td class="d-inline-flex">
                                                                                    <div>
                                                                                        <a href="{{route('editOtherFacilities', ['id' => $card->id])}}"
                                                                                            class="btn btn-primary btn-sm p-2"><i
                                                                                                class="feather icon-eye m-0 p-0"></i></a>
                                                                                    </div>
                                                                                    <div>
                                                                                        <form
                                                                                            action="{{ route('deleteOtherFacilities', ['id' => $card->id]) }}"
                                                                                            method="post">
                                                                                            @csrf
                                                                                            @method('DELETE')
                                                                                            <button type="submit"
