        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Edit Blog Tags Page</h5>
                        <span>Here you can add,update and delete Edit Blog Tags page slider image and Edit Blog
                            Tags
                            card image and
                            text
                            etc.</span>
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                    ...
                                                    <div class="tab-content card-block">
                                                        ...
                                                        <div class="tab-pane active " id="profile7" role="tabpanel">
                                                            <form
                                                                action="{{route('editBlogTags',['id' => $BlogsTag->id])}}"
