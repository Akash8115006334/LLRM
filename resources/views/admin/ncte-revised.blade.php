        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>NCTE Revised Page</h5>
                        <span>Here you can add,update NCTE Revised page content
                            etc.</span>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>NCTE Revised
                                                                Link</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('editNcteRevised')}}" method="post"
                                                                ...
                                                                <div class="row justify-content-center mb-3">
                                                                    <div class="col-md-7">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <label
                                                                                    class="form-label col-form-label">NCTE
                                                                                    Title</label>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="d-inline-flex">
                                                                                            <div>
                                                                                                <a href="{{ Storage::url($NcteRevised->pdf ?? '') }}"
                                                                                                    target="_blank"
                                                                                            ...
                                                                                            <div>
                                                                                                <form
                                                                                                    action="{{ route('deleteNcteRevised', ['id' => $NcteRevised->id]) }}"
                                                                                                    method="post">
                                                                                                    @csrf
                                                                                                    @method('DELETE')
                                                                                                    <button
