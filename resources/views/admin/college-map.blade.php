        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>College Map Page</h5>
                        <span>Here you can add,update College Map page content
                            etc.</span>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab"
                                                                href="#section7" role="tab"><i
                                                                    class="icofont icofont-ui-user "></i>College Map
                                                                Section</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content card-block">
                                                        <div class="tab-pane active" id="section7" role="tabpanel">
                                                            <form action="{{route('editCollegeMap')}}" method="post"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    class="form-control"
                                                                                    value="{{ old('title',$CollegeMap->title ?? '')}}">
                                                                                @error('title')
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <textarea name="content" id="ckeditor"
                                                                                    ...
                                                                                    required>{{ old('content', $CollegeMap->content ?? '' )}}</textarea>
                                                                                @error('content')
                                                                                <div class="text-danger">{{ $message }}
                                                                                </div>
                                                                                @enderror
