...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Apr 2024 08:20:05 GMT -->
<head>
...
<div class="col-md-12">
<div class="d-grid">
<button type="button" class="btn btn-primary btn-md waves-effect text-center m-b-20">Reset Password</button>
</div>
</div>
</div>
<p class="f-w-600 text-end">Back to <a href="auth-sign-in-social.html">Login.</a></p>
<div class="row">
<div class="col-md-10">
